...
public class AircraftController {
    ...
    public String assignAirport(@PathVariable Long aircraftId, @RequestParam String airportId) {
        ...
        List<Aircraft> uusi = airport.getAircrafts();
        uusi.add(aircraft);
        airport.setAircrafts(uusi);
